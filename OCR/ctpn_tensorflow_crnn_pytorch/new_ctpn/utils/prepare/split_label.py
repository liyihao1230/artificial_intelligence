...
#根据txt文件中bbox的x1,y1,x2,y2,x3,y3,x4,y4
#生成固定宽度的anchor的xmin,ymin,xmax,ymax
#以此作为输入用以计算loss


#DATA_FOLDER = "/media/D/DataSet/mlt_selected/"
#OUTPUT = "data/dataset/mlt/"
DATA_FOLDER = "/Users/yihaoli/Desktop/img_transfer/labelimg_res/"
OUTPUT = "/Users/yihaoli/Desktop/img_transfer/labelimg_res/output"
MAX_LEN = 1200
MIN_LEN = 600
