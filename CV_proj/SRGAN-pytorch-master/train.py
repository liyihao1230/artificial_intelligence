...
if __name__ == '__main__':
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        for data, target in train_bar:
            ...
            # running_results['g_loss'] = running_results['g_loss'] + g_loss.item() * batch_size
            # running_results['d_loss'] = running_results['d_loss'] + d_loss.item() * batch_size
            # running_results['d_score'] = running_results['d_score'] + real_out.item() * batch_size
            # running_results['g_score'] = running_results['g_score'] + fake_out.item() * batch_size
